...
from ..models import RegistroResiduo, HistorialEstado
from ..schemas import (
...
def crear_registro(
    ...
    db_registro = RegistroResiduo(**registro.model_dump())
...
def listar_registros(
    ...
    query = db.query(RegistroResiduo)
...
def obtener_estadisticas(db: Session = Depends(get_db)):
    ...
    total_registros = db.query(func.count(RegistroResiduo.id)).scalar()
    peso_total = db.query(func.sum(RegistroResiduo.peso_kg)).scalar() or 0.0
    ...
    ultimos_7_dias = db.query(func.count(RegistroResiduo.id))\
        .filter(RegistroResiduo.fecha_registro >= fecha_hace_7_dias)\
        .scalar()
